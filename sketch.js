...
var bottomGround
var topGround
var balloon, balloonImg,balloonJumpsound,balloonDiesound
...
if(bottomObstaclesGroup.isTouching(balloon) || balloon.isTouching(topGround) || balloon.isTouching(bottomGround) || topObstaclesGroup.isTouching(balloon)){
 if(!isDying && !balloonDiesound.isPlaying()){
